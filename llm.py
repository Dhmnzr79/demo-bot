...
EMPATHY_ADDON = (
    "\n\n"
    "Если для текущего документа включена эмпатия, начни ответ с одной короткой естественной "
    "человеческой фразы, а затем сразу переходи к сути.\n\n"
    "Эта фраза должна звучать спокойно и нормально, без пафоса, без сюсюканья "
    "и без шаблонной вежливости. Не используй клише, повторы и дежурные формулировки.\n\n"
    "Нельзя писать фразы вроде: "
    ...
    "«не переживайте», "
    "«с радостью подскажу».\n\n"
    "Эмпатичная фраза должна быть короткой, уместной и каждый раз звучать естественно. "
    "После неё не должно быть длинного вступления — только ответ по существу."
)
